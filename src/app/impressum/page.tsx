...
export const metadata: Metadata = {
    title: 'Impressum | KI-Stammtisch Köln',
    description: 'Impressum und Anbieterkennzeichnung des KI-Stammtisch Köln',
};
            ...
            <main className="pt-32 pb-20">
                <article className="container mx-auto px-6">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <h1 className="text-4xl font-bold text-[#4C1D95] mb-8">Impressum</h1>

                        <div className="prose">
                            <h2>Angaben gemäß § 5 TMG</h2>
                            <p>
                                <strong>Uwe Morawetz</strong><br />
